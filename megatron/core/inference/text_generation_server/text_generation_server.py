        ...
        with LOCK:  # Need to get lock to keep multiple threads from hitting code
            ...
            try:
                ...
                if is_span_group_enabled('inference'):
                    from megatron.core.telemetry import get_tracer, get_meter
                    from megatron.core.telemetry.propagation import extract_context
            ...
            try:
                ...
                if _otel_meter is not None:
                    from megatron.core.telemetry._instruments import record_inference_metrics
